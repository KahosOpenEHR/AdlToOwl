...
public class ObservationTranslator extends OWLModelWrapper{

	public ObservationTranslator(String nomFich){
		super(nomFich);
	}
	...
	public void Translate() throws OWLOntologyStorageException, FileNotFoundException{
		...
		StateTranslator stt = new StateTranslator();
		stt.Translate(manager, ontologyIRI, ontology, factory, parentClass, lisState);
		
		EventsTranslator ett = new EventsTranslator();
		ett.Translate(manager, ontologyIRI, ontology, factory, parentClass, lisEvents);
