...
public class ActivitiesTranslator {
	...
	public void Translate(OWLOntologyManager manager, IRI ontologyIRI, OWLOntology ontology, OWLDataFactory factory, OWLClass parentClass, List<String> lisState){
		...
		OWLClass activities = factory.getOWLClass(IRI.create(ontologyIRI+"#Activities"));
		OWLAxiom prtAxiom = factory.getOWLSubClassOfAxiom(activities,parentClass);
					...
					if(!(nomClass.equals("Tree") || nomClass.equals("List") || nomClass.equals("Cluster"))){
						if(nomClass.contains(" ")){
							...
							manager.applyChange(new AddAxiom(ontology, 
									factory.getOWLSubClassOfAxiom(factory.getOWLClass(IRI.create(ontologyIRI+"#"+nomClass)),activities)));
						}else{
							manager.applyChange(new AddAxiom(ontology, 
									factory.getOWLSubClassOfAxiom(factory.getOWLClass(IRI.create(ontologyIRI+"#"+nomClass)),activities)));
						}
