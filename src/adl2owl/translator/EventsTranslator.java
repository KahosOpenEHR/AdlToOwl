...
public class EventsTranslator {
	...
	public void Translate(OWLOntologyManager manager, IRI ontologyIRI, OWLOntology ontology, OWLDataFactory factory, OWLClass parentClass, List<String> lisProtocol){
		...
		OWLClass events = factory.getOWLClass(IRI.create(ontologyIRI+"#Events"));
		OWLAxiom prtAxiom = factory.getOWLSubClassOfAxiom(events,parentClass);
					...
					if(!(nomClass.equals("Tree") || nomClass.equals("List") || nomClass.equals("Cluster"))){
						if(nomClass.contains(" ")){
							...
							manager.applyChange(new AddAxiom(ontology, 
									factory.getOWLSubClassOfAxiom(factory.getOWLClass(IRI.create(ontologyIRI+"#"+nomClass)),events)));
						}else{
							manager.applyChange(new AddAxiom(ontology, 
									factory.getOWLSubClassOfAxiom(factory.getOWLClass(IRI.create(ontologyIRI+"#"+nomClass)),events)));
						}
